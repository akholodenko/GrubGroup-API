...
yelp_controller.prototype.get_sugguestion = function(input) {
	...
	// create instance of yelp client for API, with config info in file
	var yelp = require("yelp").createClient(JSON.parse(require('fs').readFileSync('config.yelp.json', 'utf8')));
